        ...
        <nav className="fixed top-0 w-full z-50 px-4 md:px-6 py-4">
            <div className="max-w-7xl mx-auto flex justify-between items-center glass-card !p-2 md:!p-3 !rounded-full">
                <div className="flex items-center gap-2 md:gap-3 px-2 md:px-3">
                    <a href={homeURL} className="w-10 h-10 bg-brand-600 rounded-2xl flex items-center justify-center shadow-lg shadow-brand-600/20 hover:scale-105 transition-transform">
                        <img src={logoSrc} alt={title} className="w-5 h-5 md:w-6 md:h-6" />
                    </a>
